...
public class LT460_LFU_Cache {
    ...
    // Every time, one key is referenced, first find the current node corresponding to the key, If the following node exist and the frequent is larger by one, add key to the keys of the following
    // node, else create a new node and add it following the current node.
