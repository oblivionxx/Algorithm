 ...
 */
public class LT388_Longest_Absolute_File_Path {
    public int lengthLongestPath(String input) {
	String[] tokens = input.split("\n");
	int result = 0;
	int curLen = 0;
	Stack<Integer> stack = new Stack<>(); // push current file path length including /
	...
	for (String s : tokens) {
	    ...
	    // +1 here because a "/" needs to be counted.
