...
public class LT229_Major_Element_II {
	...
	count1 = 0;
	count2 = 0;
	// rst1 and rst2 are right number, but need recount the occurrence >n/3. occurence might be negative, or the rst number is not n/3 majority but just keep there. Remeber, at most 2, could be
	// only 1.
