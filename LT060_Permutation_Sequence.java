...
public class LT060_Permutation_Sequence {
	public String getPermutation(int n, int k) {
        //The basic idea is to decide which is the correct number starting from the highest digit use k/(n-1)!
	   ...
	   LinkedList<Integer> notUsed = new LinkedList<Integer>();
        ...
        while(round>=0)
        {
            ...
            if(round>0)
                factorial /= round;			//new (n-1)!. here round is also the size of notUsed list.
            round--;
        }
